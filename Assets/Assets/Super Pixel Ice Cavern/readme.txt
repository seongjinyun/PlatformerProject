...
Did you know? You can get access to even more of my assets if you support me on Patreon!
Check it out: http://patreon.com/untiedgames
At the $10 tier, you can get access to ALL of my assets! Not your cup of tea? At the $5 tier, you can get access to all my older assets. There's also a lot more than just pixel art... I make Youtube videos, indie games, development logs, and more!
Your support helps me make even more awesome pixel art asset packs!
...
Hello! Thank you for downloading the Super Pixel Ice Cavern Tileset. Here are a few pointers to help you navigate and make sense of this zip file.
...
- UNITY USERS:
	- The spritesheets are aligned to a 16x16 grid. You can use the spritesheet for the basic 16x16 tiles and the individual PNGs for the larger objects if you prefer.
	- You'll have to set up your own colliders! That's outside my area of expertise as an artist.
	- If you purchased outside of the Unity asset store: A Unity package is included for your convenience.
...
File name definitions:
	...
	- "shadows"				These optional semitransparent tiles can be placed over the midground. Use them to add depth to your level!
...
SUPER PIXEL ICE CAVERN SPECIFIC TIPS
	- This is the first of my tilesets to include optional semitransparent shadow tiles. They're designed to be placed on a layer above the midground tiles. Please feel free to adjust their alpha in-game or with an image editor if you'd prefer stronger/weaker shadows.
	- This is also the first of my tilesets to include a Unity package. I'm not a Unity user myself, so please let me know if there's any issues with it at contact@untiedgames.com!

SUPER PIXEL ICE CAVERN LAYER ORDER (Front to back)
	- Terrain
	- Terrain BG (ice blocks, ice crystals, spikes)
